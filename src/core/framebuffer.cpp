...
Framebuffer::Framebuffer(u32 width, u32 height, u32 bits_per_pixel, u32 base_address)
    : width_(width), height_(height), bits_per_pixel_(bits_per_pixel), base_address_(base_address) {
