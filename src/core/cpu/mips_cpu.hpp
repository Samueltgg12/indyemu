...
// The CPU queries this each cycle to decide whether to take an interrupt exception.
...
public:
    ...
    void setInterruptController(InterruptController* controller) { interrupt_controller_ = controller; }
...
private:
    ...
    // Exception handling
    void takeException(u32 exc_code, u32 epc, bool in_delay_slot);
